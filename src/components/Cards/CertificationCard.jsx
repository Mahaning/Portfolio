...
`;
const Credential_ID=styled.div`
    font-size: 14px;
    text-align: center;
    margin-left: 2px;
    font-weight: 500;
...
const CertificationCard = ({certification,setOpenModal}) => {
    return (
        <NavLink href={certification.c_Link}>
        <Card>
            <Image src={certification.image}/>
            <Tags>
                
                <Platform>{certification.platform}</Platform>
                
            </Tags>
            <Details>
                <Title>{certification.title}</Title>
                <Credential_ID>Credential_ID:{certification.Credential_ID}</Credential_ID>
                <Date>{certification.date}</Date>
                <Description>{certification.description}</Description>
            </Details>
            <Members>
                {certification.member?.map((member) => (
